...
def test():
    ...
    # Apply lemmatization and stemming to the text and title columns
    ...
    # Predict probabilities using the fake news model
    res = model.predict_proba(dfForTest)
    
    # Return prediction probabilities and sentiment polarity scores
...
def predict():
    ...
    # Create a DataFrame with the api new text and title
    ...
    # Return prediction probabilities, sentiment polarity scores, and original text
    return {'FakePosibility': str(round(res[0][0], 4)),
            'RealPosibility': str(round(res[0][1], 4)),
